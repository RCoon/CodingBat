...
public class Array6Test {
    public static void main(String[] args) {
		Array6Test test = new Array6Test();
		System.out.println(test.array6(new int[] {1, 6, 4}, 0));
		System.out.println(test.array6(new int[] {1, 4}, 0));
		System.out.println(test.array6(new int[] {6}, 0));
	}
